...
def main(args):
    ...
    shape_error = interpolate(shape_test_loader, model, criterion, start_epoch, optimizer, args=args)
    parameter_error = interpolate(parameter_test_loader, model, criterion, start_epoch, optimizer, args=args)

    print('Time elapsed: {:.2f}s'.format(time.time() - start_time))


def interpolate(batch_loader, model, criterion, epoch, optimizer, args=None):
